...
export class UniToken__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class UniToken extends ethereum.SmartContract {
  static bind(address: Address): UniToken {
    return new UniToken("UniToken", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): UniToken__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new UniToken__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<UniToken__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new UniToken__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }

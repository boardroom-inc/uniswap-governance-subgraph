...
export class UniGov__getActionsResult {
...
export class UniGov__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class UniGov__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class UniGov extends ethereum.SmartContract {
  static bind(address: Address): UniGov {
    return new UniGov("UniGov", address);
  }
  ...
  getActions(proposalId: BigInt): UniGov__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new UniGov__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<UniGov__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): UniGov__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return result[0].toTuple() as UniGov__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<UniGov__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as UniGov__getReceiptResultValue0Struct
    );
  }
  ...
  proposals(param0: BigInt): UniGov__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new UniGov__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(param0: BigInt): ethereum.CallResult<UniGov__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
